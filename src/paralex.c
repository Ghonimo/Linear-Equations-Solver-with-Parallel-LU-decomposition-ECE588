...
//
//
//  New copy of parallel1.c that takes number of
//  threads as a command line argument.  Created
//  this way to help with debugging
//  
//
//  Alexander Maso
//
...
int numThreads; // Or any other way to determine the number of threads
#define M_NPROCS 8
...
int main(int argc, char* argv[]) {
    if (argc < 2 || argc > 3) {
        printf("Usage: %s <matrix_file> [NumThreads]\n", argv[0]);
        return EXIT_FAILURE;
    }
...
/////// Parallel LU Decomposition -----------------------------------
    ...
    // FIXME: outputFile logic commented out for debugging purposes
    /*
    FILE* outputFile;
    if (argc == 3) {
    ...
    */
    ...
    FILE* outputFile = stdout; // Use standard output 
